...
, 							{
								"box" : 								{
									...
									"rendermode" : 0,
									"url" : "file:///D:/Git/Vessles/Vessles%20Max/Vessles/score/Vessles-09.svg"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"data" : 									{
										"clips" : [ 											{
												"absolutepath" : "PenExerpt.wav",
												"filename" : "PenExerpt.wav",
												"filekind" : "audiofile",
												"id" : "u636024680",
												"selection" : [ 0.0, 1.0 ],
												"loop" : 1,
...
,
									...
									"parameter_enable" : 0,
									"patching_rect" : [ 307.0, 29.0, 150.0, 30.0 ],
									"pitchcorrection" : 0,
									"quality" : "basic",
									"timestretch" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"data" : 									{
										"clips" : [ 											{
												"absolutepath" : "Mutoscope.wav",
												"filename" : "Mutoscope.wav",
												"filekind" : "audiofile",
												"id" : "u009023897",
												"selection" : [ 0.437037037037037, 1.0 ],
												"loop" : 0,
												"content_state" : 												{
...
,
									...
									"outlettype" : [ "multichannelsignal", "signal", "", "dictionary" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 474.0, 25.0, 325.0, 67.0 ],
									"pitchcorrection" : 0,
									"quality" : "basic",
									"timestretch" : [ 0 ]
								}
...
, 							{
								"box" : 								{
									...
									"presentation" : 1,
									"presentation_rect" : [ 647.714285612106323, 223.0, 163.0, 163.0 ]
								}
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "multichannelsignal" ],
																	"patching_rect" : [ 50.0, 125.0, 39.0, 21.0 ],
																	"text" : "mc.-~"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "multichannelsignal" ],
																	"patching_rect" : [ 61.0, 100.0, 84.0, 21.0 ],
																	"text" : "mc.onepole~ 5"
																}
...
,
													"patching_rect" : [ 139.0, 473.0, 56.0, 21.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"fontname" : "Lato",
...
,
														...
														"boxes" : [ 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 468.0, 195.0, 50.0, 37.0 ],
																	"text" : "0.01019"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "multichannelsignal" ],
																	"patching_rect" : [ 85.085106611251831, 401.0, 42.0, 23.0 ],
																	"text" : "mc.*~"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 50.0, 295.0, 101.0, 23.0 ],
																	"text" : "scale 0.85 1 1 0.5"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 130.5, 186.0, 29.5, 23.0 ],
																	"text" : "join"
																}
...
, 															{
																"box" : 																{
																	...
																	"patching_rect" : [ 199.5, 195.0, 72.0, 23.0 ],
																	"text" : "maximum 0."
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 130.5, 125.0, 64.0, 37.0 ],
																	"text" : "route voice"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 130.5, 150.0, 41.0, 23.0 ],
																	"text" : "gate 2"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "int" ],
																	"patching_rect" : [ 196.0, 267.0, 22.0, 37.0 ],
																	"text" : "t 1"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "" ],
																	"patching_rect" : [ 188.5, 295.0, 37.0, 37.0 ],
																	"text" : "$1 50"
																}
...
, 															{
																"box" : 																{
																	...
																	"patching_rect" : [ 196.0, 340.0, 34.0, 23.0 ],
																	"text" : "line~"
																}
...
, 															{
																"box" : 																{
																	...
																	"patching_rect" : [ 95.0, 220.0, 74.0, 23.0 ],
																	"text" : "split 0.85 10"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 2,
																	"outlettype" : [ "", "" ],
																	"patching_rect" : [ 58.5, 100.0, 91.0, 37.0 ],
																	"text" : "mc.peakamp~ 5"
																}
...
, 															{
																"box" : 																{
																	...
																	"numoutlets" : 1,
																	"outlettype" : [ "multichannelsignal" ],
																	"patching_rect" : [ 65.792542000000026, 40.0, 30.0, 30.0 ]
																}
...
, 															{
																"box" : 																{
																	...
																	"numinlets" : 1,
																	"numoutlets" : 0,
																	"patching_rect" : [ 85.085113999999976, 482.0, 30.0, 30.0 ]
																}
...
,
													"patching_rect" : [ 135.5, 437.498479962348938, 83.0, 21.0 ],
													"saved_object_attributes" : 													{
														"description" : "",
														"digest" : "",
														"fontname" : "Lato",
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 1,
													"outlettype" : [ "" ],
													"patching_rect" : [ 613.0, 258.0, 75.0, 21.0 ],
													"text" : "reflection 0.6"
												}
...
, 											{
												"box" : 												{
													...
													"outlettype" : [ "multichannelsignal", "", "float", "list" ],
													"parameter_enable" : 1,
													"patching_rect" : [ 461.340426445007324, 292.498479962348938, 35.0, 65.0 ],
													"presentation" : 1,
...
, 											{
												"box" : 												{
													...
													"numinlets" : 1,
													"numoutlets" : 0,
													"patching_rect" : [ 135.5, 539.498477249626148, 30.0, 30.0 ]
												}
...
,
									...
									"presentation" : 1,
									"presentation_rect" : [ 518.0, 222.964285552501678, 117.714285612106323, 206.035714447498322 ],
									"varname" : "bpatcher",
									"viewvisibility" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 26.0, 765.234038710594177, 68.0, 21.0 ],
									"text" : "mcs.dac~ 2"
								}
...
, 			{
				"name" : "Mutoscope.wav",
				"bootpath" : "D:/Git/Vessles/Vessles Max/Vessles/media/Test Files",
				"patcherrelativepath" : "../media/Test Files",
				"type" : "WAVE",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"bootpath" : "D:/Git/Vessles/Vessles Max/Vessles/Scenes/House of Hearts/Cues",
